    ...
    return (
        <Dialog>
            ...
            <DialogContent className="sm:max-w-[400px] bg-zinc-900 border-zinc-800">
                <DialogHeader>
                    <DialogTitle className="text-white text-2xl font-semibold">Change Username</DialogTitle>
                    <DialogDescription className="text-zinc-500">
                        Fill in the form to update
                    </DialogDescription>
                </DialogHeader>
                <div className="gap-4 flex flex-col">
                    <Input placeholder="New Username" className="mb-6 border-zinc-600 h-10 text-zinc-300" />
                </div>
                <DialogFooter>
