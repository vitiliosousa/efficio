    ...
    return (
        <Dialog>
            ...
            <DialogContent className="sm:max-w-[400px] bg-zinc-900 border-zinc-800">
                <DialogHeader>
                    <DialogTitle className="text-white text-2xl font-semibold">Change Password</DialogTitle>
                    <DialogDescription className="text-zinc-500">
                        Fill in the form to update
                    </DialogDescription>
                </DialogHeader>
                <div className="gap-4 flex flex-col">
                    <Input placeholder="Old Password" className="border-zinc-600 h-10 text-zinc-300" />
                    <Input placeholder="New Password" className="border-zinc-600 h-10 text-zinc-300" />
                    <Input placeholder="Confirm Password" className="mb-6 border-zinc-600 h-10 text-zinc-300" />
                </div>
                <DialogFooter>
